...
public class TestSaturdayTime {
  ...
  public void setUp() {
    ...
    this.satOnePM = new SaturdayTime(Time.Day.SATURDAY, 13, 0);
    this.tues10AM = new SaturdayTime(Time.Day.TUESDAY, 10, 0);
    this.tues10PM = new SaturdayTime(Time.Day.TUESDAY, 22, 0);
  ...
  public void testTimeConstructor() {
    Assert.assertThrows(IllegalArgumentException.class,() ->
            new SaturdayTime(Time.Day.SUNDAY, 25, 0));
    Assert.assertThrows(IllegalArgumentException.class, () ->
            new SaturdayTime(Time.Day.SUNDAY, 23, 70));
    Assert.assertThrows(IllegalArgumentException.class, () ->
            new SaturdayTime(Time.Day.SUNDAY, -23, 0));
    Assert.assertThrows(IllegalArgumentException.class, () ->
            new SaturdayTime(Time.Day.SUNDAY, 23, -10));
  }
}
