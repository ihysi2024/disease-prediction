...
public class Controller implements ViewFeatures {
  ...
  public void toggleColor() {
    ...
    if (this.toggle) {
      ...
      IToggleStrategy toggleStrat = new ToggleHostColor(new Color(0, 0, 250, 100),
              new Color(255, 100, 200, 100),
              plannerView.getCurrentUser(),
              plannerView);
      toggleStrat.toggleColors(plannerView.getPanel().getGraphics());
      System.out.println("TOGGLE");
    }
    else {
      System.out.println("NOT TOGGLING");
      IToggleStrategy toggleStrat = new ToggleHostColor(new Color(255, 100, 200, 100),
              new Color(255, 100, 200, 100),
              plannerView.getCurrentUser(),
              plannerView);
      toggleStrat.toggleColors(plannerView.getPanel().getGraphics());
