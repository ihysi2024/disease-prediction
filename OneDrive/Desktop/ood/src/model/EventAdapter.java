...
/**
 * Adapt the provider event view to the customer event view.
 */
public class EventAdapter implements IEvent {
  ...
  public static model.IEvent convertToProviderEventType(IEvent event) {
    Time startTime = indexToTime(event.accessStartDay().getValue(),
            event.accessStartTime().accessTimeAsInt());
    Time endTime = indexToTime(event.accessEndDay().getValue(),
            event.accessStartTime().accessTimeAsInt());
   ...
   * @return Returns true if the current event's start time and end times don't overlap
   */
  @Override
  ...
  public DayOfWeek accessStartDay() {
    ...
    ITime origTime = new Time(this.adaptee.getStartTime().getDate(),
            this.adaptee.getStartTime().getHours(), this.adaptee.getStartTime().getMinutes());
  ...
  public DayOfWeek accessEndDay() {
    ITime origTime = new Time(this.adaptee.getEndTime().getDate(),
            this.adaptee.getEndTime().getHours(), this.adaptee.getEndTime().getMinutes());
    IEventTime adaptedTime = new TimeAdapter(origTime);
    return adaptedTime.accessDay();
  }
  ...
  public IEventTime accessStartTime() {
    ITime origTime = new Time(Time.Day.SUNDAY, this.adaptee.getStartTime().getHours(),
            this.adaptee.getStartTime().getMinutes());
  ...
  public IEventTime accessEndTime() {
    ITime origTime = new Time(Time.Day.SUNDAY, this.adaptee.getEndTime().getHours(),
            this.adaptee.getEndTime().getMinutes());
    return new TimeAdapter(origTime);
  }
