...
/**
 * Adapt provider features for customer features.
 */
public class FeaturesAdapter implements IFeatures {
   ...
   */
  @Override
  public void addEvent(String name, boolean isOnline, String place, DayOfWeek startDay,
                       String startTime, DayOfWeek endDay, String endTime, List<String> users) {
    ...
    this.adaptee.populateEvent(new Event(name, startTimeOfEvent, endTimeOfEvent,
            isOnline, place, users));
  }
   ...
   */
  @Override
  public void modifyEvent(cs3500.nuplanner.provider.model.IEvent originalEvent, String name,
                          boolean isOnline, String place, DayOfWeek startDay, String startTime,
                          DayOfWeek endDay, String endTime, List<String> users) {
    Time startTimeOfEvent = stringToTime(startDay.getValue() - 1, startTime);
    Time endTimeOfEvent = stringToTime(endDay.getValue() - 1, endTime);
    IEvent adaptedNewEvent = new Event(name, startTimeOfEvent, endTimeOfEvent,
            isOnline, place, users);
   ...
   */
  @Override
  public void removeEvent(String name, boolean isOnline, String place, DayOfWeek startDay,
                          String startTime, DayOfWeek endDay, String endTime, List<String> users) {
    Time startTimeOfEvent = stringToTime(startDay.getValue() - 1, startTime);
    Time endTimeOfEvent = stringToTime(endDay.getValue() - 1, endTime);
    this.adaptee.removeEvent(new Event(name, startTimeOfEvent, endTimeOfEvent, isOnline,
            place, users));
  }
   ...
   */
  @Override
  public void loadCalendarXML(String filePath) throws IOException, SAXException,
   ...
   */
  @Override
  public void scheduleEvent(String name, boolean isOnline, String place, String durationMinutes,
                            List<String> userIds) {
