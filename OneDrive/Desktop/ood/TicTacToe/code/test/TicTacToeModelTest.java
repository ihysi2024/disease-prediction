...
public class TicTacToeModelTest {
  ...
  /**
   * Tests the horizontalwin method.
   */
  @Test
  ...
  /**
   * Tests whether an invalid move has been made.
   */
  @Test
  ...
  /**
   * Tests whether a move attempt has been made after the game is over.
   */
  ...
  /**
   * Tests an illegal getMark move for a row.
   */
  ...
  /**
   * Tests an illegal getMark move for a col.
   */
  @Test(expected = IllegalArgumentException.class)
  ...
  /**
   * Tests the board in its current state.
   */
  @Test
