 ...
 *
 * @param <Piece> the type representing the pieces in the game
 */
public interface SameGameModel<Piece> {
   ...
   * @throws IllegalArgumentException if swaps is negative
   */
  void startGame(List<List<Piece>> board, int swaps);
